...
<div class="card-header bg-primary">
    ...
    <form action="/og/filter" class="d-inline" method="GET">
    <div class="form-row">
    ...
    <div class="card-body bg-dark">
                ...
                @csrf
                    <div class="form-row">
                        ...
                        <div class="col">
                            <input type="submit" class="form-control btn btn btn-primary" value="Add">
                        </div><!--col-->
                    </div><!--.form-row-->
            </form><!--form-->
    </div><!--.card-body-->
...
<table class="table table-hover">
  ...
  <tr class="table-dark text-center">
      ...
      <td>
        <a href="/og/{{$d->id}}/edit" class="btn btn-sm btn-primary">Edit</a>

        <form class="d-inline" method="post" action="/og/{{$d->id}}">
